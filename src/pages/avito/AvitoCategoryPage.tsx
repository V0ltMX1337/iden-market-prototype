...
const AvitoCategoryPage = () => {
  ...
  return (
    <>
      <AvitoHeader />
      <main className="flex bg-gray-50 min-h-screen pt-20">
        <aside className="w-64 p-4 bg-white border-r">
          <h2 className="font-bold mb-2">Фильтры</h2>

          <div className="mb-6">
            <h3 className="font-medium mb-1">Цена (₽)</h3>
          ...
          <div>
            <h3 className="font-medium mb-1">Город</h3>
            <div className="max-h-40 overflow-y-auto">
              {cities.map(city => (
                <label key={city.id} className="flex items-center space-x-2 mb-1 text-sm">
                  <Checkbox
        ...
        <section className="flex-1 p-6">
          ...
          <h1 className="text-2xl font-bold mb-4">{category?.name || "Категория не найдена"}</h1>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {paginatedAds.map((ad) => (
                      ...
                      >
                       ...
                       <div className="relative w-full h-[240px] bg-gray-200 overflow-hidden rounded-md">
  <img
    src={ad.links?.[0]}
    alt={ad.title}
    loading="lazy"
  ...
  />
                        ...
                        <CardContent className="flex flex-col flex-1">
                          ...
                          <p className="text-sm text-gray-600 mt-auto">{ad.price} ₽</p>
