...
const ProductPageAR = () => {
  ...
  const product = {
    id: productId,
    title: "Намордник для собак, пластиковый №4 М",
    sku: "WVP-123456789",
    rating: 4.9,
    reviewsCount: 15,
    price: 465,
    ...
    images: [
      ...
      "https://avatars.mds.yandex.net/get-mpic/5165418/2a0000018ac1bb0fbc4a724f90b52c7280bf/optimize",
      "https://avatars.mds.yandex.net/get-mpic/1567763/2a0000018ac1bb0f55f7b34b53729710823f/optimize",
    ],
    variants: [
